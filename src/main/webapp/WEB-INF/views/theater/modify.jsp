					...
					<div class="all-comments">
						<div class="all-comments-info">
							<div class="agile-info-wthree-box">
								...
								<input type="hidden" value="${modify.TNum}" name="tNum"/>
								
									상영관 지점명<br/>
									<input type="text" name="tThtr" placeholder="${modify.TThtr}"/><br/><br/>
									상영관 주소<br/>		           					   
