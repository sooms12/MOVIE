...
<html lang="en">
<head>
<title>YL CINEMA-상영관 상세정보</title>
					...
					<div class="all-comments">
						<div class="all-comments-info">
							<div class="agile-info-wthree-box">
								<form>
									상영관 지점명<br/>
									<input type="text" name="tThtr" value="${view.TThtr}" readonly><br/><br/>
									상영관 주소<br/>		           					   
									<input type="text" name="tAddr" value="${view.TAddr}" readonly><br/><br/>
...
<script>
	...
	$('#modify').click(function(){
		location.href = "tModiForm?tNum=${view.TNum}";
	});

	// 상영관 삭제
	$('#delete').click(function() {
		location.href = "tDelete?tNum=${view.TNum}";
	});
