...
<!-- 상영정보 시작 -->
	<div class="faq">
		<h4 class="latest-text w3_faq_latest_text w3_latest_text">상영정보</h4>
			<div class="container">
				<div class="agileits-news-top">
					<ol class="breadcrumb">
					  <li><a href="indexForm">홈</a></li>
					  <li class="active">상영정보</li>
					</ol>
				</div>
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">상영하실 날짜를 선택해주세요! →</a></li>
					...
					<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									<table id="table-breakpoint">
										  ...
										  <tr>
										  	<th><img src="img/${mvlist.mvImgName}" width="370px" height="500px" /></th>
										  	<th>
										  		<h4>『 ${mvlist.mvTitle} 』</h4>
										  		<br/><br/>
										  		장르 : ${mvlist.mvCategory} | 상영시간 : ${mvlist.mvRuntime} | 상영등급 : ${mvlist.mvRating}
										  		<br/><br/>
										  		${mvlist.mvPlot}
										  		<br/><br/>
										  		<h6>※날짜를 선택하시면 상영시간을 확인하실 수 있습니다.</h6>
										  	</th>
										  </tr>
							...
							<div role="tabpanel" class="tab-pane fade" id="c" aria-labelledby="c-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>6월28일(수) 상영정보</h4> ${mvlist.mvTitle}
									</div>
									<table id="table-breakpoint">
										<thead>
										  <tr>
									...
									<c:forEach var="list" items="${list}">
										<tr>	
											...
											<input type="hidden" value="${list.SNum}" id="sNum" />
											<td></td>
											<td>${list.STime}</td>
											<td>${list.TThtr}</td>
											<td>
												<input class="but-but" type="button" value="예매하기" id="ticket" onclick="location.href='sView?sNum=${list.SNum}'">
											</td>
											</c:if>
										</tr>
									</c:forEach>
							...
							<div role="tabpanel" class="tab-pane fade" id="d" aria-labelledby="d-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>6월29일(목) 상영정보</h4> ${mvlist.mvTitle}
									</div>
									<table id="table-breakpoint">
										<thead>
										  <tr>
							...
							<div role="tabpanel" class="tab-pane fade" id="e" aria-labelledby="e-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>6월30일(금) 상영정보</h4> ${mvlist.mvTitle}
									</div>
									<table id="table-breakpoint">
										<thead>
										  <tr>
							...
							<div role="tabpanel" class="tab-pane fade" id="a" aria-labelledby="a-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>07월01일(토) 상영정보</h4> ${mvlist.mvTitle}
									</div>
									<table id="table-breakpoint">
										<thead>
										  <tr>
							...
							<div role="tabpanel" class="tab-pane fade" id="b" aria-labelledby="b-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>07월02일(일) 상영정보</h4> ${mvlist.mvTitle}
									</div>
									<table id="table-breakpoint">
										<thead>
										  <tr>
