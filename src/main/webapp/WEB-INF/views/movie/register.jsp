						...
						<ul class="nav navbar-nav">
							<c:choose>
								<c:when test="${loginId == 'admin'}">
									<li class="active"><a href="mvRegiForm">영화등록</a></li>
					...
					<div class="all-comments">
						<div class="all-comments-info">
							<div class="agile-info-wthree-box">
								<form action="mvRegister" method="POST" encType="multipart/form-data">
									제목<br/>
									<input type="text" name="mvTitle"/><br/><br/>        					   
									장르<br/>
									<input type="text" name="mvCategory"/><br/><br/>
									줄거리<br/>
									<textarea rows="20" cols="40" name="mvPlot"></textarea><br/><br/>
									감독<br/>
									<input type="text" name="mvDirector"/><br/><br/>
									출연진<br/>
									<input type="text" name="mvActor"/><br/><br/>
									개봉일<br/>
									<input type="date" name="mvRelease"/><br/><br/>
									상영시간<br/>
									<input type="text" name="mvRuntime"/><br/><br/>
									상영등급<br/>
									<select name="mvRating" value="mvRating"><br/><br/>
									...
									포스터<br/>
									<input type="file" name="mvImg"/><br/>
									스틸컷<br/>
									<input type="text" name="mvStill1"/><br/>
									<input type="text" name="mvStill2"/><br/>
									<input type="text" name="mvStill3"/><br/>
									<input type="text" name="mvStill4"/><br/>
									<input type="text" name="mvStill5"/><br/><br/>
									
									<input type="submit" id="mvList" value="등록하기">
									<div class="clearfix"> </div>
								</form>
							</div>
						</div>
